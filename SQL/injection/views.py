    ...
    try:
        ...
        try:
            ...
            if(user_count >= 1):
                ...
                # Add user
                query = f"INSERT INTO injection (username, password) VALUES('{username}', '{password}');"
                print(query) 
    ...
    try:
        ...
        try:
            ...
            if(user_count == 1):
                ...
                print(SQL_RunQuery(query, commit=False))
            #     user_password = SQL_RunQuery(query=query, commit=False)[0][0]
            #     if(user_password == password):
            #         response = {"code": status.HTTP_200_OK, "message": "Login successful"}
            #     else:
            #         response = {"code": status.HTTP_401_UNAUTHORIZED, "message": "Incorrect password"}
            # else:
